...
sf::write_sf(simodels::si_zones, "origin_zones.geojson")
sf::write_sf(simodels::si_pubs, "destination_points.geojson")
```
...
```{r}
hist(origin_zones$all)
plot(sf::st_geometry(origin_zones))
plot(sf::st_geometry(destination_points), add = TRUE)
```
