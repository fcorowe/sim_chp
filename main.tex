...
\item
  ...
  \item
    What is needed: different approaches - use of machine learning (because it is not possible), generalised linear mixed models (GLMMs) to capture heterogeneity and spatial non-stationary, greater use of causal inference approaches and warnings of the misuse of statistical significance and~\emph{P}~values.
  \end{itemize}
\end{itemize}
...
\subsection{\texorpdfstring{Reproducibility }{Reproducibility }}\label{reproducibility}}
...
\item
  ...
  Benefits (Brunsdon 2016) (Rowe et al. 2020):
...
\tightlist
\item
  (Oshan 2021) ``Although local models and spatial non-stationarity were originally used to diagnose problems arising from spatial structure, there has been limited recent research using local SI models''.
\end{itemize}
...
\hypertarget{capturing-spatial-and-temporal-heterogeneity}{%
\subsection{\texorpdfstring{Capturing spatial and temporal heterogeneity }{Capturing spatial and temporal heterogeneity }}\label{capturing-spatial-and-temporal-heterogeneity}}
...
\hypertarget{i-plan-to-use-the-text-below-to-fill-the-sections-above}{%
\section{\texorpdfstring{\textbf{I plan to use the text below to fill the sections above}}{I plan to use the text below to fill the sections above}}\label{i-plan-to-use-the-text-below-to-fill-the-sections-above}}
