...
Fourth, considerable methodological work has been done to conceptualise and operationalise the influence of spatial structure in SIMs (T. M. Oshan 2021).
...
We discussed issues around reproducibility challenging the practical application of SIMs, but that with packages like \texttt{SPINT} (T. Oshan 2021) and our own efforts with the \texttt{simodels} package in \emph{R} (see Section \ref{enabling-infrastructure}, the tide is beginning to turn.
...
Limited research has focused on explicitly capturing patterns of non-stationarity in spatial interaction modelling despite the availability of suitable methods (T. M. Oshan 2021).
...
Yet, as noted above, limited progress has been made on capturing these patterns of non-stationarity (T. M. Oshan 2021).
...
\leavevmode\vadjust pre{\hypertarget{ref-oshan_spatial_2021}{}}%
Oshan, Taylor. 2021. {``Spatial {Interaction} {Modeling} ({SpInt}).''} \url{https://github.com/pysal/spint}.
