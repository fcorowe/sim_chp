...
Four generalisable approaches have been proposed to account for spatial structure in distinctive ways: the competing destination model by including an accessibility measure [<!--# Ref: Fotheringham  -->]; the Box--Cox transform by using a Box--Cox functional form of distance [<!--# Ref: Tiefelsdorf  -->]; spatial econometric modelling [<!--# Ref: Bolduc / LeSage and Pace -->]; and eigenvector spatial filtering by incorporating spatial dependence or spatial autocorrelation [<!--# Ref: Griffith -->].
Fifth,

statistical framework - estimation using OLS based on logs formulations, then Poisson and more sophisticated count models.

(1) alternative developments - frameworks e.g. radiation model to account what? discrete choice modelling to account for micro behaviour
