...
Four different forms of SIM are generally calibrated.
...
(1) conceptualising - not only predictive capability, (2) alternative conceptualisations - frameworks e.g.~radiation model to account what?
discrete choice modelling to account for micro behaviour (3) capture the effects of spatial structure on interactions - LeSage, Fotheringham,
