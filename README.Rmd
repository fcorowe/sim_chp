...
Third, ML/AI are also expected to enhance the ability of SIMs to help identify causal links.
...
To take an example, ML approaches can identify links between a wide range of explanatory variables and the amount of flow in large datasets, going beyond the focus on trip distances and 'attractiveness' in traditional SIMs, that were developed before large datasets were available.
